  ...
  describe("testing update Role", () => {
    beforeEach((done) => {
      collection.deleteAll({"tenantId":tenantOne})
        ...
        .then((value) => {
          return collection.save(roleTestData.validObject1);
        })
        .then((value) => {
          return collection.save(roleTestData.validObject2);
        })
        .then((value) => {
          return collection.save(roleTestData.validObject3);
        })
        .then((value) => {
          return collection.save( roleTestData.validObject4);
        })
        .then((value) => {
          done();
        });
    ...
    it('should update a role with new values', (done) => {
      var res = role.update("T001", "Admin_One11",{
        "enableFlag": true,
        "roleName": "Admin_One11",
